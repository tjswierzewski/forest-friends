  ...
  return (
    <Container maxWidth="xl" sx={{ margin: '0 auto 2rem auto' }}>
      ...
      <Typography variant="body1" sx={{ margin: '0 auto', maxWidth: '80%' }}>
        ...
        we’re able to offer our users the possibility to support researchers and wildlife associations
        while remaining in close contact with the adopted animal.
      </Typography>
      ...
      <Typography variant="body1" sx={{ margin: '0 auto', maxWidth: '80%' }}>
        ...
        The tracker will serve as a medium for researchers to understand the animal’s movements and
        common behaviors in order to better protect it and enable it to thrive in the current
      ...
      <Typography variant="body1" sx={{ margin: '0 auto', maxWidth: '80%' }}>
        ...
        people's sanctuaries. Collect animals, Grow your animals, and Bond with your animals in an
